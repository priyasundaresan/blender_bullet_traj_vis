...
class BulletManipulator:
    ...
    def load_robot(self, robot_path, ee_joint_name, ee_link_name,
        ...
        for j in range(pybullet.getNumJoints(robot_id)):
            ...
            keep = jtype in [pybullet.JOINT_REVOLUTE, pybullet.JOINT_PRISMATIC]
            rev_finger = 'finger' in jname or 'knuckle' in jname
            if keep and not rev_finger:
                joint_ids.append(j)
        ...
        #assert(ee_link_id is not None) # TODO
